...
Contributions are welcome. `go-ruby-irb/irb` is built to a small set of
...
The library is in [`github.com/go-ruby-irb/irb`](https://github.com/go-ruby-irb/irb).
This documentation site is in [`github.com/go-ruby-irb/docs`](https://github.com/go-ruby-irb/docs).
