# go-ruby-irb documentation

**Pure-Go, MRI-4.0.5-faithful Ruby irb (no cgo)**

`go-ruby-irb/irb` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `irb`,
matching reference Ruby (MRI) behaviour. The module path is
`github.com/go-ruby-irb/irb`.
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `irb`, validated against reference Ruby, at 100%
...
```sh
go get github.com/go-ruby-irb/irb
```
...
| Repo | What it is |
| --- | --- |
| [`irb`](https://github.com/go-ruby-irb/irb) | the library — Ruby's `irb` in pure Go |
| [`docs`](https://github.com/go-ruby-irb/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-irb.github.io`](https://github.com/go-ruby-irb/go-ruby-irb.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-irb/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-irb/irb](https://github.com/go-ruby-irb/irb).
