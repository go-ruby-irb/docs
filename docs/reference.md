...
The public API lives at the module root (`github.com/go-ruby-irb/irb`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `irb`, while the surface follows
...
- **[pkg.go.dev/github.com/go-ruby-irb/irb](https://pkg.go.dev/github.com/go-ruby-irb/irb)**

The module's [README](https://github.com/go-ruby-irb/irb#readme) carries worked
