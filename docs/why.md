...
`go-ruby-irb/irb` reimplements Ruby's `irb` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-irb/irb` directly, with no Ruby runtime;
